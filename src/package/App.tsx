...
function App(): JSX.Element {
  ...
  useEffect(() => {
    const loadInitialEditorState = async () => {
      const initialEditorState = await loadContent();
      initialEditorStateRef.current = initialEditorState as EditorState;
    }
  ...
  const onChange = (editorState: EditorState) => {
    ...
    console.log("editorStateRef", editorStateRef.current);
  }


  const onSubmit = () => {
    console.log(JSON.stringify(editorStateRef.current, null, 2));
